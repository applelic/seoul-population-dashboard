...
function renderBirthMonthlyTrendChart() {
  ...
  const MONTH_COLORS = [
    '#A8E8CE', '#5FCC9E', '#2EAD78',  // 1·2·3월 (초록)
    '#A4D4F8', '#58B0F0', '#2484CC',  // 4·5·6월 (파랑)
    '#FCCCA4', '#F89850', '#E06820',  // 7·8·9월 (주황)
    '#D0B4F0', '#A878DC', '#7E48C0',  // 10·11·12월 (보라)
  ];
...
// ══════════════════════════════════════════════
const _hhRaw = {
  '1인':    [ 257382,  382024,  502245,  675739,  854606, 1115744, 1564187, 1627480, 1660813, 1699910],
  '2인':    [ 330684,  426210,  524663,  670455,  781527,  930467, 1076409, 1080790, 1090555, 1110342],
  '3인':    [ 537364,  615127,  670538,  732043,  788115,  817440,  776479,  774023,  772973, 774590],
  '4인':    [ 914443,  996854,  989621,  917243,  807836,  701945,  544807,  528911,  511523, 494112],
  '5인이상':[ 775148,  545579,  398869,  314410,  272213,  218894,  136936,  130455,  123638, 115261],
};
const _hhTotal = [281, 297, 309, 331, 350, 378, 410, 414, 416, 419];
const _genRaw = {
  '2세대': [1804454, 1775431, 1740777, 1710502, 1691450, 1644223, 1611980, 1593557, 1573061, 1555031],
  '1인':   [1138860, 1180540, 1229421, 1299787, 1390701, 1489893, 1564187, 1627480, 1660813, 1699910],
  '1세대': [ 598233,  614037,  626988,  645266,  665193,  680825,  689093,  685396,  687649, 702904],
  '3세대': [ 181625,  173908,  164734,  155420,  142292,  131646,  125014,  121065,  116025, 110149],
};
const _genTotal = [378, 381, 384, 390, 398, 405, 410, 414, 416, 419];
let hhTab = 'hh';
